			...
			flow: &model.Record{
				RawRecord: model.RawRecord{
					...
					Metrics: ebpf.BpfFlowMetrics{
						...
						PktObservations: [4]ebpf.BpfPktObservationT{{Direction: model.DirectionEgress}},
						NbObservations:  1,
						Bytes:           456,
						Packets:         123,
						Flags:           0x100,
			...
			flow: &model.Record{
				RawRecord: model.RawRecord{
					...
					Metrics: ebpf.BpfFlowMetrics{
						...
						SrcMac:          model.MacAddr{0x04, 0x05, 0x06, 0x07, 0x08, 0x09},
						DstMac:          model.MacAddr{0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f},
						PktObservations: [4]ebpf.BpfPktObservationT{{Direction: model.DirectionIngress}, {Direction: model.DirectionEgress}},
						NbObservations:  2,
						Bytes:           64,
						Packets:         1,
						Flags:           0x100,
