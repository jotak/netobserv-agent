...
type Record struct {
	...
	ZoneId                 uint32               `protobuf:"varint,28,opt,name=zone_id,json=zoneId,proto3" json:"zone_id,omitempty"`
	UdnId                  string               `protobuf:"bytes,29,opt,name=udn_id,json=udnId,proto3" json:"udn_id,omitempty"`
	AdditionalSrcAddr      []*IP                `protobuf:"bytes,30,rep,name=additional_src_addr,json=additionalSrcAddr,proto3" json:"additional_src_addr,omitempty"`
	AdditionalDstAddr      []*IP                `protobuf:"bytes,31,rep,name=additional_dst_addr,json=additionalDstAddr,proto3" json:"additional_dst_addr,omitempty"`
}
...
func (x *Record) GetZoneId() uint32 {
	if x != nil {
		return x.ZoneId
	}
	return 0
...
func (x *Record) GetAdditionalSrcAddr() []*IP {
	if x != nil {
		return x.AdditionalSrcAddr
	}
	return nil
}

func (x *Record) GetAdditionalDstAddr() []*IP {
	if x != nil {
		return x.AdditionalDstAddr
	}
	return nil
}
...
var file_proto_flow_proto_rawDesc = []byte{
	...
	0x22, 0x9c, 0x0a, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x65,
	...
	,
...
var file_proto_flow_proto_depIdxs = []int32{
	...
	7,  // 12: pbflow.Record.additional_src_addr:type_name -> pbflow.IP
	7,  // 13: pbflow.Record.additional_dst_addr:type_name -> pbflow.IP
	7,  // 14: pbflow.Network.src_addr:type_name -> pbflow.IP
	7,  // 15: pbflow.Network.dst_addr:type_name -> pbflow.IP
	2,  // 16: pbflow.Collector.Send:input_type -> pbflow.Records
	1,  // 17: pbflow.Collector.Send:output_type -> pbflow.CollectorReply
